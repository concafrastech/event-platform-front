...
const appRoutes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'jovem-cards/:type/:id', component: JovemCardsComponent, canActivate:[UserGuard]},
            {path: 'jovem-list/:type/:id', component: JovemListComponent, canActivate:[UserGuard]},
