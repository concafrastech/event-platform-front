        ...
        children: [
...

            {
                ...
                children: [
                    ...
                    {
                        path: 'brincadeiras',
                        component: BrincadeirasComponent,
                        canActivate: [UserGuard],
                        children: [
                            { path: '', redirectTo: 'brincadeiras', pathMatch: 'full' },
                            { path: 'infancia-brincadeiras/:id', component: InfanciaBrincadeirasComponent, canActivate: [UserGuard] }
                        ]
                    },
                    {
                        path: 'jogos-digitais',
                        ...
                        children: [
                            ...
                            { path: 'infancia-games/:id', component: InfanciaGamesComponent, canActivate: [UserGuard] }
                        ],
                    },
                ]
            },
