...
@Component({
  selector: "app-jovem-right-sidebar-sidebar",
  templateUrl: "./jovem-right-sidebar.component.html",
  styleUrls: ["./jovem-right-sidebar.component.css"],
  providers: [
    UserService,
    ShareMessageService,
    EpicService,
...
export class JovemRightSidebarComponent implements OnInit {
  constructor(
