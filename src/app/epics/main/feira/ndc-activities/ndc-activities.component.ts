...
@Component({
  ...
  providers: [StageService, ActivityService, UserService],
})
export class NdcActivitiesComponent implements OnInit {
  public activityList: Activity[] = [];
  public stage: Stage;

  constructor(private _route: ActivatedRoute, private _router: Router, private _stageService: StageService, private _activityService: ActivityService,
    public _navbarService: NavbarService, private _userService: UserService) { }
