...
@Component({
  selector: 'app-jovem-cards',
  templateUrl: './jovem-cards.component.html',
  styleUrls: ['./jovem-cards.component.css'],
  providers: [LectureService, TrailService, StageService, ActivityService, ClassroomService]
})
export class JovemCardsComponent implements OnInit, AfterViewInit {
