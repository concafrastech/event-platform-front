...

    {
        ...
        children: [
            ...
            { path: 'casa-oracao', component: InfanciaCasaOracaoComponent, canActivate: [UserGuard] },
            {
                ...
                canActivate: [UserGuard],
                children: [
                    { path: 'jogos-digitais/:id', component: JogosDigitaisComponent, canActivate: [UserGuard] },
                    { path: 'brincadeiras', component: BrincadeirasComponent, canActivate: [UserGuard] },

                ],
            },
            {
                path: 'atividades',
                component: InfanciaAtividadesComponent,
                canActivate: [UserGuard],
                children: [
                    { path: 'laborterapias', component: LaborterapiasComponent, canActivate: [UserGuard] },
                    { path: 'desenhos-imprimir', component: DesenhosImprimirComponent, canActivate: [UserGuard] },
                ],
            },

            {
                path: 'casa-nvl-1',
                component: InfanciaCasaNvl1Component,
                canActivate: [UserGuard],
                children: [
                    { path: 'bercario', component: BercarioComponent, canActivate: [UserGuard] },
                    { path: 'maternal', component: MaternalComponent, canActivate: [UserGuard] },
                    { path: 'jardim', component: JardimComponent, canActivate: [UserGuard] },
                ],
            },
