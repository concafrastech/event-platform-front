                ...
                children: [
                    { path: '', redirectTo: 'parquinho', pathMatch: 'full' },
                    {
                        ...
                        children: [
                            ...
                            { path: 'infancia-brincadeiras', component: InfanciaBrincadeirasComponent, canActivate: [UserGuard] }
                        ]
                    },
                    {
                        path: 'jogos-digitais',
                        ...
                        children: [
                            ...
                            { path: 'infancia-games', component: InfanciaGamesComponent, canActivate: [UserGuard] }
                        ],
                    },
                ]
            },
